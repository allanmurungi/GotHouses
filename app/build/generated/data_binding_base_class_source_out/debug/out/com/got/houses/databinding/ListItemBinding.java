...
public final class ListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView txvHouse;

  private ListItemBinding(@NonNull CardView rootView, @NonNull TextView txvHouse) {
    this.rootView = rootView;
    this.txvHouse = txvHouse;
  }
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.txv_house;
      TextView txvHouse = rootView.findViewById(id);
      if (txvHouse == null) {
        break missingId;
      }

      return new ListItemBinding((CardView) rootView, txvHouse);
    }
